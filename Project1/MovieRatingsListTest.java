...
//		if (testFind(movieRatingsList, "Casablanca") && testFind(movieRatingsList, "Twilight"))
...
//		MovieRatingsList res = list.getNBestRankedMovies(4);
//		if (numNodes(res) != 4) {
//			System.out.println(
...
//		
//		boolean b5 = res.head().next().next().getMovieTitle().equals("Ocean eleven");
//		boolean b6 = res.head().next().next().next().getMovieTitle().equals("Casablanca");
//		boolean b7 = res.head().next().next().getMovieTitle().equals("Casablanca");
//		boolean b8 = res.head().next().next().next().getMovieTitle().equals("Ocean eleven");
//		
//		if ((b1 && b2 && b5 && b6))
